...
namespace ScrumBoard
{
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            TaskI Writeabstract = Creator.Create_task("Write abstract", "Complete earlier", Task_priority.HARD);
            ...
            TaskI throw_out_the_trash = Creator.Create_task("throw out the trash", "today", Task_priority.EASY);
        ...
        {
            foreach (TaskI task in column.Find_tasks())
            {
                Print_task(task);
            }
        }
        private static void Print_task(TaskI task) 
        {
